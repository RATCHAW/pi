...
- Fixed server runtime phase ownership, cwd validation for reopened and symlink-backed sessions, and inherited `PI_SESSION_FILE` leakage ([#7396](https://github.com/earendil-works/pi/pull/7396)).
